      ...
      <div className="Emp_Detail">
        ...
        <div className="data1">
          <div className="details">
            ...
            <h5>
              <strong>Email ID</strong> :- {emp_data.email}
            </h5>
            <h5>
              <strong>Mobile Number</strong> :- +91 {emp_data.number}
            </h5>
          </div>
          ...
          <div className="details">
            ...
            <h5>
              <strong>Date of Birth</strong> :- {emp_data.date}
            </h5>
            <h5>
              <strong>Address</strong> :- {emp_data.address}
            </h5>
          </div>
        ...
        <div className="editButton">
          <button className=" btnEdit mb-5" onClick={() => editData()}>
            Edit Details
          </button>
        </div>
      </div>
        ...
        <div className="editForm">
          <div className="col1">
            <div className="row editName mb-4">
              <label htmlFor="editName" className="col-sm-4 col-form-label">
                <strong>Name</strong>
              </label>
            ...
            <div className="row editEmail mb-4">
              <label htmlFor="editEmail" className="col-sm-4 col-form-label">
            ...
            <div className="row mb-4">
              <label htmlFor="editAddress" className="col-sm-4 col-form-label">
          ...
          <div className="col2">
            <div className="row editPhone mb-4">
              <label htmlFor="inputPhone" className="col-sm-5 col-form-label">
              ...
              <div className="col-sm-7">
                <input
                  ...
                  minLength={10}
                  maxLength={10}
                  defaultValue={emp_data.number}
                />
              </div>
            </div>

            <div className="row mb-4">
              <label htmlFor="domain" className="col-sm-5 col-form-label">
            ...
            <div className="row mb-4">
              <label htmlFor="editDob" className="col-sm-5 col-form-label">
